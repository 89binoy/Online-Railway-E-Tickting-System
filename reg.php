...
include_once "include/navlogout.php";
?>
...
<?php
   ...
   if(isset($_POST['register'])){
         ...
         $query = "INSERT INTO users(f_name,l_name,email,password,gender,mobile) VALUES ('".$_POST['f_name']."','".$_POST['l_name']."','".$_POST['email']."','".$_POST['password']."','".$_POST['gender']."','".$_POST['mobile']."')";
